...
module.exports.run = async (bot, message, args) => {
    ...
    .addField(":page_with_curl: Commandes information", "e!help | e!sondage | [giveaway] | [userinfo] | [infoserv]")
    .addField(":computer:  Commandes basic", "e!ping | e!say | e!sayembed")
    .addField(":robot:  Commmdes pour le bot", "e!prefix | [modifstatus] | [modifactivity]")
    .addField(":tada: Commandes fun", "e!chien | e!chat | e!avatar | e!8ball | [math]")
